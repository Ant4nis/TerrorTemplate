...
/// <summary>
/// A ScriptableObject that holds and manages a player's statistics like health, level, and madness.
/// This allows for easy adjustment and scaling of player attributes within the Unity Editor.
/// </summary>
...
public class PlayerStats : ScriptableObject
{
    ...
    /// <summary>
    /// Resets the player's statistics to their maximum values across all configurable fields.
    /// This method is typically used to restore the player's condition to full capacity at the start of a game or after a revival.
    /// </summary>
    ...
    /// <summary>
    /// Resets only the essential health-related statistics of the player to their maximum values.
    /// Useful for scenarios where only partial recovery is needed.
    /// </summary>
